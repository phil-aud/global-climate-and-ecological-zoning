...
The published GIS products (rasters/vectors) are hosted externally on Zenodo —
see [Output data products](#output-data-products).
...
The published GIS products are **not stored in this repository** (they are large
...
`ZENODO_RECORD_ID`, `ZENODO_DOI`, and `DATA_PUBLISHED` in
[`frontend/src/utils/dataProducts.js`](frontend/src/utils/dataProducts.js).
